 ...
 * [template.core.base.store.submit.SubmitOutbox] — three concurrent VMs editing three distinct
 ...
 * exception so the [template.core.base.store.submit.DraftSubmitHandler] routes to the
...
) : org.mifos.core.data.banking.LoanRepository by delegate {
 ...
 * as [template.core.base.store.error.ErrorCategory.Network] — which is the trigger
 * required for [template.core.base.store.submit.DraftSubmitHandler]'s silent auto-save path.
 */
