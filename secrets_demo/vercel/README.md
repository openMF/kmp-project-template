...
|------|---------|------------|
| `secrets/vercel/token` | API token | `VERCEL_TOKEN` |
| `secrets/vercel/org_id` | Org/Team ID | `VERCEL_ORG_ID` |
| `secrets/vercel/project_id` | Project ID | `VERCEL_PROJECT_ID` |

## Commands

```bash
echo "your-vercel-token"      > secrets/vercel/token
echo "your-org-id"            > secrets/vercel/org_id
echo "your-project-id"        > secrets/vercel/project_id
