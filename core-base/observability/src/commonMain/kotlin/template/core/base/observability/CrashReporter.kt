 ...
 * [template.core.base.observability.di.observabilityModule] binding in their app module
 * with a real implementation (Firebase Crashlytics, Sentry, Bugsnag, Datadog RUM, etc.).
 *
 * ## Why a separate seam from [template.core.base.analytics.AnalyticsHelper]?
 *
