...
#   secrets/appstore/AuthKey.p8          — ASC API key
#   secrets/appstore/key_id              — ASC key ID
#   secrets/appstore/issuer_id           — ASC issuer ID
#   secrets/match/match_ci_key           — SSH key for Match git repo (local only)
#   secrets/match/.match_password        — Match encryption password (local only)
#
