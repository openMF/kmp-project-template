...
6. Copy it to `secrets/firebase/service-account.json`
...
|------|---------|------------|
| `secrets/firebase/service-account.json` | Service account JSON | `FIREBASECREDS` |
| `secrets/firebase/android_app_id` | Android prod App ID | `FIREBASE_ANDROID_APP_ID` |
| `secrets/firebase/android_demo_app_id` | Android demo App ID | `FIREBASE_ANDROID_DEMO_APP_ID` |
| `secrets/firebase/ios_app_id` | iOS App ID | `FIREBASE_IOS_APP_ID` |

## Commands

```bash
mkdir -p secrets/firebase
cp secrets_demo/firebase/service-account.json secrets/firebase/service-account.json
# Replace with real JSON from Firebase Console

echo "1:123456789:android:abc123" > secrets/firebase/android_app_id
echo "1:123456789:android:def456" > secrets/firebase/android_demo_app_id
echo "1:123456789:ios:ghi789"     > secrets/firebase/ios_app_id
...
```
This can be set in `secrets/shared_keys.env` or as a GitHub Actions variable.
