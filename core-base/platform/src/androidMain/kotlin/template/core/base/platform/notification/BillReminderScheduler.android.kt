...
import template.core.base.platform.notification.internal.BillReminderWorker
...
actual class BillReminderScheduler(
    ...
    actual suspend fun schedule(bill: BillReminderSchedule) = withContext(Dispatchers.IO) {
    ...
    actual suspend fun cancel(billId: String) = withContext(Dispatchers.IO) {
