...
class LoanDaoTest {
    ...
    fun setup() {
        ...
        // per-platform, so naming BundledSQLiteDriver here is what pinned this test to
        // desktop and left android/native/ios never running it.
    ...
    @AfterTest
    fun teardown() {
        // stopKoin() must run even if setup failed, or a single fault cascades into
        // KoinApplicationAlreadyStartedException on every later test.
