...
|------|---------|------------|
| `secrets/cloudflare/api_token` | API token string | `CLOUDFLARE_API_TOKEN` |
| `secrets/cloudflare/account_id` | Account ID string | `CLOUDFLARE_ACCOUNT_ID` |

## Commands

```bash
echo "your-api-token" > secrets/cloudflare/api_token
echo "your-account-id" > secrets/cloudflare/account_id
