...
object KoinModules {
    private val dataModule = module {
        // appStoreModule must load before features that resolve get(AppStoreRegistry.X);
        // co-located with DataModule since the demo store bindings depend on DAOs from
        // DatabaseModule (transitively included via DataModule).
