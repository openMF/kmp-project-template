 ...
 * is registered under [org.mifos.core.store.AppStoreRegistry.SpotRate] so that
 * consumers can apply a [template.core.base.store.screen.FetchPolicy.NETWORK_ONLY]
