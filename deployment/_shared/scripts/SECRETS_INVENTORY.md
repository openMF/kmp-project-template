...
|---|---|---|---|:-:|
| FIREBASECREDS | firebase_service_account_json | secrets/firebase/service-account.json | firebase-app-distribute | ✅ |
| PLAYSTORECREDS | play_publisher_service_account_json | secrets/play/service-account.json | android-play-internal-publish | ✅ |
| APPSTORE_KEY_ID | appstore_key_id | secrets/appstore/key_id | ios-app-store | ✅ |
| APPSTORE_ISSUER_ID | appstore_key_issuer_id | secrets/appstore/issuer_id | ios-app-store | ✅ |
| APPSTORE_PRIVATE_KEY_P8 | appstore_private_key_p8 | secrets/appstore/AuthKey.p8 | ios-app-store | ✅ |
| UPLOAD_KEYSTORE_FILE | kmp_template_release_keystore | secrets/keystores/upload_keystore.keystore | android-signing | ✅ |
| KEYSTORE_PASSWORD | upload_keystore_file_password | secrets/keystores/upload_keystore.properties | android-signing | ✅ |
| MATCH_GIT_PRIVATE_KEY | match_git_ssh_private_key | secrets/match/match_ci_key | ios-signing | ✅ |
| MATCH_PASSWORD | match_password | secrets/match/.match_password | ios-signing | ✅ |
| CLOUDFLARE_API_TOKEN | cloudflare_pages_api_token | secrets/cloudflare/api_token | web-cloudflare-pages-publish | — |
| CLOUDFLARE_ACCOUNT_ID | cloudflare_account_id | secrets/cloudflare/account_id | web-cloudflare-pages-publish | — |
| NETLIFY_AUTH_TOKEN | netlify_auth_token | secrets/netlify/auth_token | web-netlify-publish | — |
| NETLIFY_SITE_ID | netlify_site_id | secrets/netlify/site_id | web-netlify-publish | — |
| VERCEL_TOKEN | vercel_token | secrets/vercel/token | web-vercel-publish | — |
| VERCEL_ORG_ID | vercel_org_id | secrets/vercel/org_id | web-vercel-publish | — |
| VERCEL_PROJECT_ID | vercel_project_id | secrets/vercel/project_id | web-vercel-publish | — |
