 ...
 * sources aren't visible without a test-fixtures plugin. Update both fakes in lockstep
 * if the contract evolves.
 *
 * The bill-reminder feature pushes this fake hard in the **multi-formKey** test
 * scenario — three concurrent VMs share one outbox and produce three distinct
 * `(formKey = "bill", uniqueKey = bill_id)` rows without colliding.
 */
