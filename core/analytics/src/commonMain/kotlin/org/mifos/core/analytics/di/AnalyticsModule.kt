 ...
 *
 * ## Why this exists alongside [template.core.base.analytics.di.analyticsModule]?
 *
 ...
 * ```
 *
 * **(d) Use the [template.core.base.analytics.StubAnalyticsHelper] for debug builds:**
 * ```kotlin
 ...
 * ```
 *
 * @see template.core.base.analytics.AnalyticsHelper Contract being bound
 * @see template.core.base.analytics.NoOpAnalyticsHelper Default toolkit implementation
 * @see template.core.base.analytics.di.analyticsModule Framework-level expect/actual variant
 */
