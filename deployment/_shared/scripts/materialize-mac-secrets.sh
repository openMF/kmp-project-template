...
[[ -n "${MAC_APP_STORE_CERT_B64:-}" ]] && echo "$MAC_APP_STORE_CERT_B64" | base64 -d > secrets/desktop/mac_app_store.p12
[[ -n "${MAC_INSTALLER_CERT_B64:-}" ]] && echo "$MAC_INSTALLER_CERT_B64" | base64 -d > secrets/desktop/mac_installer.p12
