...
|------|---------|------------|
| `secrets/netlify/auth_token` | Personal access token | `NETLIFY_AUTH_TOKEN` |
| `secrets/netlify/site_id` | Site UUID | `NETLIFY_SITE_ID` |

## Commands

```bash
echo "your-netlify-token" > secrets/netlify/auth_token
echo "your-site-id"       > secrets/netlify/site_id
