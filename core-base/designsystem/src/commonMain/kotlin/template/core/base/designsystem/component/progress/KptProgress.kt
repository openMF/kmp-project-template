...
sealed interface KptProgress {
    ...
    /**
     * Single shimmer bar (delegates to [template.core.base.designsystem.component.KptShimmerLoadingBox]).
     ...
     * [template.core.base.designsystem.component.KptShimmerListItem]). Use for list-screen
     * loading states.
     *
